...
typedef struct _rscp_ArmDisarm {
    pb_size_t which_value_wrapper;
    union _rscp_ArmDisarm_value_wrapper {
        bool value;
    } value_wrapper;
} rscp_ArmDisarm;
...
#define rscp_ArmDisarm_init_default              {0, {0}}
...
#define rscp_ArmDisarm_init_zero                 {0, {0}}
...
#define rscp_StartExploration_dummy_field_tag    1
...
X(a, STATIC,   ONEOF,    BOOL,     (value_wrapper,value,value_wrapper.value),   1)
...
X(a, STATIC,   SINGULAR, BOOL,     dummy_field,       1)
...
#define rscp_StartExploration_size               2
