...
from boxy_spiral import BoxyShelly
import math as mt
import time as tm
...
class SimpleGPSController(Node):
    def __init__(self, radius):
        ...
        self.boxy_spiral = BoxyShelly(5,self.reached_target_radius)
        self.r_azi_buffer = self.shelly_spiral.azi_theta_buffer() if self.shell else self.boxy_spiral.r_azi_buffer()
        self.r_buffer = self.shelly_spiral.geo_r_buffer() if self.shell else self.boxy_spiral.r_buffer()
